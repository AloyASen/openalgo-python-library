...
# -*- coding: utf-8 -*-
"""
Test layr0_imc API with live connection
...
def test_connection():
    ...
    print("\n" + "="*60)
    print("Testing layr0_imc API Connection")
    print("="*60)
...
def main():
    """Run all tests"""
    print("\n" + "="*60)
    print("layr0_imc API Test Suite v1.0.36")
    ...
    if connection_result and connection_result.get('status') == 'success':
        ...
        print("Please ensure:")
        print("1. layr0_imc server is running at http://127.0.0.1:5000")
        print("2. The API key is valid")
        print("3. The broker is connected in layr0_imc")
